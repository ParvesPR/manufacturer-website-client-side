        ...
        <section className='w-11/12 py-10 px-20 mx-auto'>
            <div className="bg-[url('/src/assets/images/section1.jpg')] h-[100%] bg-no-repeat">
                <div className='py-32 px-12'>
                    ...
                    <h1 className='uppercase block text-5xl py-3 text-white font-bold'>Replacement</h1>
                    <h1 className='uppercase block text-5xl py-3 text-white font-bold'>Car parts</h1>
                    <Link to="/parts">
