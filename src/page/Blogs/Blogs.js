        ...
        <div className='bg-base-200 p-10 grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
            <div className="lg:max-w-lg bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <p>Optimizing performance in a React application Keeping component state local where necessary. Memoizing React components to prevent unnecessary re-renders. Code-splitting in React using dynamic import() Windowing or list virtualization in React. Lazy loading images in React.</p>
                </div>
            </div>
            ...
            <div className="lg:max-w-lg bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <p>State updates in React are asynchronous; when an update is requested, there is no guarantee that the updates will be made immediately. The updater functions enqueue changes to the component state, but React may delay the changes, updating several components in a single pass.</p>
                </div>
            </div>
